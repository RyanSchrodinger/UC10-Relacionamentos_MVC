...
namespace Uc_10_Ryan_Relacionamentos_Descricao_00501.Controllers
{
    public class VendaController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["VendedorId"] = new SelectList(_context.Set<Vendedor>(), "VendedorId", "Cpf");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("VendaId,ClienteId,VendedorId,AutomovelId,DataVenda,ValorVenda")] Venda venda)
        {
            ...
            ViewData["VendedorId"] = new SelectList(_context.Set<Vendedor>(), "VendedorId", "Cpf", venda.VendedorId);
            return View(venda);
        }
