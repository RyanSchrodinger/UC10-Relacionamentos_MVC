...
namespace Uc_10_Ryan_Relacionamentos_Codigo_00003.Controllers
{
    public class EspecialidadesController : Controller
    {
        ...
        public EspecialidadesController(Uc_10_Ryan_Relacionamentos_Codigo_00003Context context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EspecialidadeId,Nome")] Especialidade especialidade)
        {
