...
namespace Uc_10_Ryan_Relacionamentos_Descricao_00501.Controllers
{
    public class VendedorController : Controller
    {
        ...
        public VendedorController(Uc_10_Ryan_Relacionamentos_Descricao_00501Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("VendedorId,Nome,Email,Cpf")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VendedorId,Nome,Email,Cpf")] Vendedor vendedor)
        {
