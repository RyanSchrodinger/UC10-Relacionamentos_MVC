...
namespace Uc_10_Ryan_Relacionamentos_Descricao_00500.Controllers
{
    public class PacienteController : Controller
    {
        ...
        public PacienteController(Uc_10_Ryan_Relacionamentos_Descricao_00500Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PacienteId,Nome,Email")] Paciente paciente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PacienteId,Nome,Email")] Paciente paciente)
        {
